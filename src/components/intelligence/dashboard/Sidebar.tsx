...
export default function Sidebar({ collapsed, setCollapsed, activeSector, setActiveSector }: SidebarProps) {
  const NAV = [
    ...
    { id: "resources", label: "Resources", icon: (c: string) => <BookOpen size={16} color={c} /> },
