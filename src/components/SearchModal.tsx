...
const DOCS: Doc[] = [
  ...
  { id:"r06", type:"report",  title:"BRIDGE White Paper",                                  subtitle:"Foundational research — methodology, sector framework, and thesis", date:"Aug 2025", kw:["white paper","foundation","thesis","methodology"], route:"/resources/white-paper" },
  { id:"r07", type:"report",  title:"2025 Annual Sector Review",                           subtitle:"Full-year retrospective across all 12 sectors and 2026 outlook",    date:"Dec 2025", kw:["annual review","2025","retrospective","year in review"], route:"/resources/annual-review-2025" },
  { id:"r08", type:"report",  title:"Ghana Policy Tracker 2025\u20132026",                 subtitle:"Sankofa Initiative, 24-hour economy, and policy landscape",         date:"Feb 2026", kw:["policy tracker","sankofa","government","legislation"], route:"/resources/policy-tracker" },
  { id:"r09", type:"report",  title:"Monthly Dashboard \u2014 March 2026",                 subtitle:"Monthly intelligence snapshot with sector pulse and signals",        date:"Mar 2026", kw:["monthly","dashboard","march","pulse","signals"], route:"/resources/monthly-dashboard" },
  { id:"r10", type:"report",  title:"Ghana Intelligence Q1 2026",                          subtitle:"Quarterly briefing on Ghana economic performance and sectors",       date:"Mar 2026", kw:["ghana","intelligence","quarterly","q1","2026"], route:"/resources/ghana-intelligence" },
  { id:"r11", type:"report",  title:"Cannabis Licensing Intelligence",                     subtitle:"NCC cannabis licensing series \u2014 11 licence categories",         date:"Mar 2026", kw:["cannabis","licence","ncc","hemp","marijuana"], route:"/resources/cannabis-intelligence" },
  ...
  { id:"p05", type:"page",    title:"Contact BRIDGE PBC",                                  subtitle:"Get in touch — submit a question, book a call, or partner",  kw:["contact","email","phone","partner"], route:"/contact" },
  { id:"p06", type:"page",    title:"FAQ & Help Centre",                                   subtitle:"Frequently asked questions about BRIDGE and membership",     kw:["faq","help","questions","support"], route:"/faq" },
  { id:"p07", type:"page",    title:"Membership",                                          subtitle:"Free and Paid access to intelligence, community, and deal flow", kw:["membership","pricing","subscribe","join"], route:"/membership" },
  { id:"p08", type:"page",    title:"Insights & Analysis",                                 subtitle:"Latest analysis, sector briefs, and strategic intelligence", kw:["insights","analysis","blog","articles","strategy"], route:"/insights" },
  { id:"p09", type:"page",    title:"Policy Updates",                                      subtitle:"Ghana policy developments and their sector implications",    kw:["policy","government","regulation","budget"], route:"/policy" },
  { id:"p10", type:"page",    title:"Community Forum",                                     subtitle:"Connect with members, share insights, and collaborate",      kw:["community","forum","members","discussion"], route:"/community" },
  { id:"p11", type:"page",    title:"Services",                                            subtitle:"Research & Guidance, Venture Development, Direct Investment", kw:["services","research","venture","investment","consulting"], route:"/services" },
  { id:"p12", type:"page",    title:"Terms of Service",                                    subtitle:"BRIDGE PBC usage terms and policies",                        kw:["terms","legal","agreement"], route:"/terms" },
  { id:"p13", type:"page",    title:"Privacy Policy",                                      subtitle:"How BRIDGE collects, uses, and protects your data",          kw:["privacy","data","cookies","personal information"], route:"/privacy" },
];
