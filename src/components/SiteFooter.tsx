...
// ============================================================================
// BRIDGE SiteFooter — Shared footer component for all pages
// ============================================================================
...
const mobileCategoryHref: Record<string, string> = {
  Company: "/about",
  Services: "/services",
  Resources: "/resources",
  Insights: "/insights",
...
const BridgeLogoWhite = () => (
  <a href="/" style={{ display: "flex", alignItems: "center", height: "40px", textDecoration: "none" }}>
    <svg viewBox="0 0 4113.9 932.3" height="36" style={{ display: "block" }}>
      ...
      <path fill={colors.white} d="M4092.2,677.1l-7.3-10.4c.2,0,.3,0,.4-.2,2-.9,3.6-2.1,4.6-3.8s1.6-3.6,1.6-6.1c0-3.6-1.2-6.3-3.6-8.4s-5.7-3-10-3h-13v31.8h5.9v-9.3h8.5l6.5,9.3h6.4v.1ZM4083.7,651.9c1.3,1.1,2,2.7,2,4.7s-.6,3.6-2,4.7-3.3,1.7-5.9,1.7h-6.9v-12.6h6.9c2.6,0,4.5.5,5.9,1.6h0v-.1Z" />
    ...
    <footer style={{ backgroundColor: colors.primary, padding: "0" }}>
      ...
      {isMobile ? (
        ...
        <div style={{ padding: "32px 20px 16px", display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <span style={{ fontSize: "12px", color: colors.accent, fontWeight: "600", fontFamily: "'DM Sans', sans-serif" }}>
                info@bridgepbc.com
              </span>
            </div>
        ...
        <>
          <div style={{ padding: "64px 80px 32px", display: "grid", gridTemplateColumns: "325px 1fr", gap: "220px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ fontSize: "14px", color: colors.accent, fontFamily: "'DM Sans', sans-serif", margin: "0", fontWeight: "600" }}>
                  info@bridgepbc.com
                </p>
              </div>
            </div>
          ...
          {/* Bottom row: Subscribe + Sector Grid */}
          <div
            style={{
              padding: "0 80px 20px",
              display: "grid",
