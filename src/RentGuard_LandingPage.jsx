  ...
  if (mob) return (
    <nav style={{ position: 'relative', background: C.ink, borderBottom: `1px solid ${C.border}`, padding: '0 20px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 999 }}>
      ...
      <button onClick={onLogin}
        style={{ background: C.lime, color: C.ink, border: 'none', padding: '8px 16px', borderRadius: 7, fontFamily: "'Space Grotesk', sans-serif", fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>
        Demo →
      </button>
    </nav>
  );
