  ...
  return (
    <div className="np pad-topbar" style={{position:'sticky',top:0,zIndex:100,background:C.paper,borderBottom:`1px solid ${C.border}`,padding:'10px 40px',display:'flex',justifyContent:'space-between',alignItems:'center',boxShadow:'0 1px 8px rgba(0,0,0,0.06)',overflow:'hidden'}}>
      ...
      <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
        ...
        <span className="mob-hide" style={{fontFamily:F.sans,fontSize:'11px',color:C.muted}}>Ghana Cannabis Intelligence · Licence 07 · Transportation · Members Brief</span>
        <span className="mob-show" style={{fontFamily:F.sans,fontSize:'11px',fontWeight:700,color:C.forest}}>07 · Transportation</span>
      </div>
...
const Cover = ({logoRef}) => (
  <div className="pad-cover" style={{background:C.ink,padding:'48px 64px 0',position:'relative',overflow:'hidden'}}>
    <div style={{position:'absolute',right:'-20px',top:'-30px',fontFamily:F.display,fontSize:'clamp(180px,35vw,480px)',fontWeight:900,color:'rgba(255,255,255,0.022)',pointerEvents:'none',userSelect:'none',letterSpacing:'-12px',lineHeight:1}}>07</div>
    <div style={{maxWidth:'900px',margin:'0 auto',position:'relative'}}>
      ...
      <div style={{display:'flex',alignItems:'center',gap:'10px',marginBottom:'20px',flexWrap:'wrap'}}>
        <div style={{background:C.lime,padding:'4px 12px',fontFamily:F.sans,fontSize:'8px',fontWeight:800,letterSpacing:'3px',textTransform:'uppercase',color:C.ink}}>LICENCE 07 · ENABLING</div>
      ...
      <h1 style={{fontFamily:F.display,fontSize:'clamp(30px,5.5vw,68px)',fontWeight:900,color:C.paper,lineHeight:1.08,marginBottom:'20px',maxWidth:'800px'}}>
        Transportation<br/>
        <span style={{fontWeight:400,fontStyle:'italic',color:'rgba(250,248,243,0.55)',fontSize:'0.72em'}}>The Chain-of-Custody Link Between Every Licence in the Value Chain</span>
      </h1>
      <PullQuote onDark>
        Hemp does not move itself. Every gram that travels from farm to processor, from processor to test lab, from test lab to exporter, requires a licensed transporter with a manifest, GPS-tracked secure vehicle, and NCC chain-of-custody documentation. Ghana has a deep logistics ecosystem. It has zero licensed cannabis transporters.
      </PullQuote>
      <div style={{borderTop:`1px solid rgba(255,255,255,0.09)`,paddingTop:'28px',marginTop:'8px',display:'flex',flexWrap:'wrap'}} className="stats-row">
        {[
          {v:'63',       l:'BRIDGE Score™',              s:'Enabling · Emerging Tier'},
          {v:'0',        l:'Licensed Cannabis Transporters',s:'Zero in Ghana — March 2026'},
          {v:'16+',      l:'US States with Transporter Licences',s:'Proving the dedicated carrier model works'},
          {v:'2-person', l:'Crew Requirement',              s:'Standard in regulated markets — driver + security'},
          {v:'$50K–300K',l:'Entry Capital Range',           s:'Vehicle fit-out + GPS + NCC approval'},
        ].map((s,i) => (
  ...
  <div className="pad-section" style={{background:C.paperDark,padding:'40px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      ...
      <div className="toc-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'0'}}>
        {[
          {n:'01',t:'Why Now — The February 2026 Milestone',s:'Every licence movement requires a manifest — and zero licensed transporters exist',id:'s01'},
          {n:'02',t:'The Transportation Thesis',s:'Chain-of-custody infrastructure that connects every other licence',id:'s02'},
          {n:'03',t:'Ghana Logistics Infrastructure Fit',s:'Tema corridors, freight ecosystem, GDP cold chain',id:'s03'},
          {n:'04',t:'Business Models',s:'4 carrier configurations — local to pharmaceutical GDP',id:'s04'},
          {n:'05',t:'Unit Economics',s:'Per-trip, per-km, contract revenue — 4 configurations',id:'s05'},
          {n:'06',t:'Value Chain Position',s:"Transportation's role — every movement requires a manifest",id:'s06'},
          {n:'07',t:'Competitive Landscape',s:'Ghana vs. 7 African peers — cannabis logistics comparison',id:'s07'},
          {n:'08',t:'Regulatory Roadmap',s:'NCC transport licence, manifest system, GPS requirements',id:'s08'},
          {n:'09',t:'Risk Register',s:'Full matrix — 8 risks, severity, mitigations',id:'s09'},
          {n:'10',t:'BRIDGE Impact Score™',s:'4-dimension analysis, composite 63/100',id:'s10'},
...
const WhyNow = () => (
  <div id="s01" className="pad-section" style={{background:C.paper,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 01" title="Why Now" stat="Feb 2026" label="Every Movement Needs a Manifest" defaultOpen={true}>
      <SectionRule/>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'32px',maxWidth:'700px'}}>26 February 2026: Every Cannabis Shipment in Ghana Now Requires a Licensed Transporter — and None Exist</h2>
      <div style={{display:'grid',gridTemplateColumns:'1.1fr 0.9fr',gap:'48px'}} className="tc">
        <div>
          <p className="dc" style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'18px'}}>
            On 26 February 2026, Ghana launched its national cannabis licensing regime. For every movement of hemp biomass, processed product, or medicinal cannabis between licensed facilities, Licence 07 creates the legal requirement: a manifest, a GPS-tracked secure vehicle, an NCC-registered driver, and chain-of-custody documentation at every handoff. Without a licensed transporter, product cannot legally leave the farm, the processor, or the testing lab.
          </p>
          <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'18px'}}>
            In mature cannabis markets, transportation is one of the most reliably profitable service businesses. At least 16 US states have stand-alone transporter licences — businesses that move cannabis B2B between licensed facilities for a fee. Canada, the Netherlands, and most European medical cannabis markets require licensed pharmaceutical distributors for medicinal product movements. The model is proven: mandatory demand, recurring transaction revenue, no direct commodity risk.
          </p>
          <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink}}>
            Ghana has an active, well-networked freight and logistics sector anchored at Tema and Takoradi ports. The Tema–Ouagadougou corridor carries more cargo than any other West African transit route. Private security firms already provide cash-in-transit and high-value escort services. The infrastructure to build a licensed cannabis transporter exists — it needs NCC approval, vehicle compliance upgrades, and the GPS-manifest technology stack to sit on top.
          </p>
        </div>
        <div>
          <div style={{background:C.ink,padding:'24px',marginBottom:'16px'}}>
            <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.lime,marginBottom:'14px'}}>Transportation Requirements at a Glance</div>
            {[
              {l:'NCC Licence',v:'Licence 07 · Transportation'},
              {l:'Vehicle requirement',v:'Locked, secure cargo compartment'},
              {l:'Tracking',v:'GPS real-time location — NCC reporting'},
              {l:'Crew standard',v:'2-person — driver + security'},
              {l:'Documentation',v:'Manifest per shipment; chain-of-custody'},
              {l:'Cold chain scope',v:'GDP-compliant reefer for pharmaceutical'},
              {l:'Move types',v:'B2B only — no consumer delivery'},
...
The Tema–Ouagadougou corridor is the most active transit route in West Africa. A cannabis transporter licensed in Ghana can serve the full domestic chain and — as ECOWAS neighbours adopt hemp frameworks — position for cross-border hemp fibre, seed, and extract movement that no other West African country can currently handle.
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{marginTop:'40px',borderTop:`1px solid ${C.border}`,paddingTop:'28px'}}>
        <Eyebrow>Transportation Demand Timeline · 2026–2030</Eyebrow>
...
const Thesis = () => (
  <div id="s02" className="pad-section" style={{background:C.paperDark,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 02" title="The Thesis" stat="16+" label="US States with Transporter Licences">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
        <span style={{fontFamily:F.mono,fontSize:'9px',fontWeight:700,color:C.lime,letterSpacing:'1px'}}>§ 02</span>
        <span style={{fontFamily:F.sans,fontSize:'10px',fontWeight:700,letterSpacing:'2.5px',textTransform:'uppercase',color:C.muted,marginLeft:'6px'}}>The Transportation Thesis</span>
      </div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'48px'}} className="tc">
        <div>
          <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'18px'}}>
            Transportation (Licence 07) is the connective tissue of the cannabis value chain. It does not produce anything — it moves everything. Farm-to-processor, processor-to-lab, lab-to-exporter, processor-to-dispensary: every movement between licensed facilities requires a manifest, a GPS-tracked vehicle, a licensed driver, and NCC chain-of-custody documentation. No movement happens without it.
          </p>
          <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'18px'}}>
            The North American precedent is instructive. In US states with regulated cannabis, at least 16 have stand-alone transporter licences — businesses that earn per-trip fees from licensed producers, processors, retailers, and laboratories. These are not commodity-risk businesses: the transporter does not own the product, does not bear crop failure risk, and does not need to secure offtake contracts. They charge for movement and documentation. Revenue scales directly with sector activity.
          </p>
          <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink}}>
            Ghana's logistics ecosystem is the most developed in West Africa. Tema port handles 85% of national trade. The Tema–Ouagadougou corridor is West Africa's most reliable transit route. Private security firms provide cash-in-transit services across the country. The inputs for a cannabis transporter are already present — they require compliance configuration and NCC approval, not construction from scratch.
          </p>
        </div>
        <div>
          <PullQuote>
            The transporter does not compete in commodity markets. They do not grow, process, or sell hemp. They charge a compliance fee for every gram that moves between licensed facilities — and every gram must move through them.
          </PullQuote>
          <div style={{background:C.paper,border:`1px solid ${C.border}`,padding:'20px',marginTop:'8px'}}>
            <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.muted,marginBottom:'14px'}}>Cannabis Transport: US State Models as Ghana Benchmark</div>
            {/* SVG Bar Chart */}
            <svg viewBox="0 0 340 140" style={{width:'100%',display:'block'}}>
              {[
                {yr:'CA',v:100,val:'Full rules'},
                {yr:'CO',v:95,val:'METRC'},
                {yr:'OR',v:88,val:'Manifests'},
                {yr:'WA',v:85,val:'GPS req.'},
                {yr:'NV',v:80,val:'2-crew'},
                {yr:'Ghana',v:40,val:'2026 →'},
              ].map((d,i) => (
                <g key={i}>
              ...
              <text x={10} y={12} style={{fontFamily:'DM Sans,sans-serif',fontSize:'9px',fill:C.faint}}>Regulatory maturity index — US cannabis transport benchmarks vs Ghana (indicative)</text>
            </svg>
            <div style={{marginTop:'8px',display:'flex',gap:'12px',flexWrap:'wrap'}}>
              {[{c:C.border,l:'US peer models'},{c:C.limeDark,l:'Most mature'},{c:C.lime,l:'Ghana trajectory'}].map((s,i) => (
      ...
      {/* 4 demand drivers */}
      <div style={{marginTop:'40px',borderTop:`1px solid ${C.border}`,paddingTop:'28px'}}>
        <Eyebrow>Four Transport Demand Drivers Across Ghana Value Chain</Eyebrow>
        {/* Desktop grid */}
        <div className="mob-hide" style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:'0',marginTop:'14px'}}>
          {[
            {n:'Farm-to-Processor Flow',d:'Every cultivation licence holder must transport biomass to a licensed processor. Timing is critical — post-harvest hemp degrades without climate-controlled transport and storage. The transporter is the revenue enabler for cultivators.'},
            {n:'Processor-to-Lab Sampling',d:'Every processing batch requires testing samples delivered to the Licence 05 lab before product can be released. Multiple testing events per batch = multiple transport events per processing run.'},
            {n:'Export Staging',d:'Finished products moving from processor or storage to Tema or Takoradi port require a licensed transporter with export documentation. Every export shipment is a transport event.'},
            {n:'Pharmaceutical Distribution',d:'Medicinal cannabis products moving to dispensaries and hospitals require GDP-compliant cold-chain transport with documented temperature monitoring. Highest per-shipment revenue in the transport category.'},
          ].map((d,i) => (
        ...
        <MobCarousel items={[
          {n:'Farm-to-Processor',icon:'🚚',d:'Every cultivation licence requires biomass transport to processor. Timing critical — post-harvest degradation is a real risk without rapid compliant transport.'},
          {n:'Processor-to-Lab',icon:'🔬',d:'Testing samples required per batch. Multiple testing events per processing run = multiple transport events generating recurring fee income.'},
          {n:'Export Staging',icon:'🚢',d:'Finished product moving to Tema or Takoradi port requires licensed transporter with manifest and export documentation. Every export = a transport event.'},
          {n:'Pharmaceutical GDP',icon:'💊',d:'Medicinal cannabis to dispensaries and hospitals requires GDP cold-chain transport. Highest per-shipment rate in the transport category.'},
        ]} renderCard={(d,i) => (
...
const GhanaFit = () => (
  <div id="s03" className="pad-section" style={{background:C.paper,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 03" title="Ghana Fit" stat="4 Corridors" label="Key Cannabis Routes">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
        <span style={{fontFamily:F.mono,fontSize:'9px',fontWeight:700,color:C.lime,letterSpacing:'1px'}}>§ 03</span>
        <span style={{fontFamily:F.sans,fontSize:'10px',fontWeight:700,letterSpacing:'2.5px',textTransform:'uppercase',color:C.muted,marginLeft:'6px'}}>Ghana Logistics Infrastructure Fit</span>
      </div>
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'12px',maxWidth:'700px'}}>West Africa's Most Active Trade Corridors — Running Right Through Ghana's Cannabis Zones</h2>
      <p style={{fontFamily:F.body,fontSize:'16px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'32px',maxWidth:'700px'}}>
        Ghana's logistics infrastructure is the most developed in West Africa. Tema port handles 85% of national trade and serves as the primary gateway for landlocked Burkina Faso, Mali, and Niger. The country has a dense road-freight network, established pharmaceutical distribution chains, and private security firms already operating high-value cargo escort. Cannabis transport layers compliance and documentation on an existing, capable logistics foundation.
      </p>
      <div className="mob-hide" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'24px',marginBottom:'32px'}}>
        {[
          {
            corridor:'Tema–Cultivation Zone Routes',tier:'PRIMARY',color:C.lime,
            route:'Tema Port → Accra → Volta Region / Ashanti cultivation zones',
            distance:'100–350km range',
            fit:'Core biomass transport corridor connecting primary cultivation zones to Tema port storage and processing cluster. Road infrastructure is good; travel times predictable. Highest expected cannabis transport volume in Phase 1.',
            note:'Primary route for export-bound processed product from Ashanti/Volta zones',
          },
          {
            corridor:'Accra–Kumasi Central Spine',tier:'HIGH FIT',color:C.lime,
            route:'Accra → Kumasi → Bono / Ashanti cultivation and processing zones',
            distance:'270km; 4–5 hour journey',
            fit:'The most heavily trafficked freight corridor in Ghana. Connects Kumasi processing and storage hub to Accra and Tema. Dual-use: biomass from Ashanti/Bono cultivation zones outbound; seed and inputs inbound from Tema.',
            note:'Critical mid-country spine — existing logistics infrastructure is dense and reliable',
          },
          {
            corridor:'Northern Savannah Corridor',tier:'MEDIUM-HIGH FIT',color:C.limeDark,
            route:'Kumasi → Tamale → Upper East/West cultivation zones',
            distance:'400–600km range; longer haul',
            fit:'Serves northern cultivation zones where large-scale hemp farming is viable. Road quality variable; journey times unpredictable in wet season. Near-farm storage nodes at Tamale reduce long-haul transport frequency. Higher premium pricing justified by distance and challenge.',
            note:'Near-farm storage reduces transport frequency; premium long-haul pricing applies',
          },
          {
            corridor:'Trans-Volta Export Corridor',tier:'MEDIUM FIT',color:C.limeDark,
            route:'Volta Region → Ho → Tema port via Accra or via Accra–Aflao border',
            distance:'180–320km depending on origin',
            fit:'Volta Region is the highest-potential hemp agro-ecology zone. Product from Hohoe and Kpandu districts routes via Ho to Tema for export. Secondary route via Aflao border point serves potential ECOWAS regional export to Togo and Benin.',
            note:'Volta Region cultivation zone has a natural port corridor; ECOWAS cross-border potential via Aflao',
          },
        ].map((r,i) => (
          <div key={i} style={{border:`1px solid ${C.border}`,padding:'20px'}}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'12px'}}>
              <div style={{fontFamily:F.display,fontSize:'14px',fontWeight:700,color:C.ink,lineHeight:1.2,paddingRight:'12px'}}>{r.corridor}</div>
            ...
            {[{l:'Route',v:r.route},{l:'Distance',v:r.distance},{l:'Fit',v:r.fit}].map((f,j) => (
              <div key={j} style={{display:'flex',gap:'8px',marginBottom:'5px'}}>
                <span style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,color:C.faint,minWidth:'60px',flexShrink:0,marginTop:'2px'}}>{f.l.toUpperCase()}</span>
      ...
      <MobCarousel items={[
        {corridor:'Tema–Cultivation Routes',tier:'PRIMARY',color:C.lime,route:'Tema Port → Accra → Volta / Ashanti',distance:'100–350km',fit:'Core biomass corridor to Tema port storage and processing cluster. Good roads; predictable timing. Highest Phase 1 volume.',note:'Primary export-bound route'},
        {corridor:'Accra–Kumasi Spine',tier:'HIGH FIT',color:C.lime,route:'Accra → Kumasi → Bono / Ashanti',distance:'270km; 4–5 hours',fit:'Most trafficked freight corridor in Ghana. Connects Kumasi hub to Tema. Dense existing logistics infrastructure.',note:'Critical mid-country spine'},
        {corridor:'Northern Savannah Corridor',tier:'MEDIUM-HIGH',color:C.limeDark,route:'Kumasi → Tamale → Upper regions',distance:'400–600km',fit:'Northern cultivation zones. Variable roads; longer haul. Premium pricing justified by distance and challenge.',note:'Near-farm storage reduces trip frequency'},
        {corridor:'Trans-Volta Export Corridor',tier:'MEDIUM FIT',color:C.limeDark,route:'Volta Region → Ho → Tema port',distance:'180–320km',fit:'Highest-potential hemp zone routes via Ho to Tema. ECOWAS cross-border potential via Aflao border.',note:'ECOWAS cross-border export potential'},
      ]} renderCard={(r,i) => (
        <div style={{border:`1px solid ${C.border}`,background:C.paper,padding:'18px',height:'100%'}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'12px'}}>
            <div style={{fontFamily:F.display,fontSize:'15px',fontWeight:700,color:C.ink,lineHeight:1.2}}>{r.corridor}</div>
      ...
      <div style={{background:C.paperDark,padding:'24px',borderTop:`3px solid ${C.ink}`}}>
        <Eyebrow>Vehicle &amp; Infrastructure Requirements vs. Ghana Provision</Eyebrow>
        <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:'0',marginTop:'14px'}} className="tc">
          {[
            {param:'Freight Vehicles',req:'Enclosed, lockable cargo compartment',ghana:'Dense road-freight ecosystem; retrofit is standard',fit:'★★★★★'},
            {param:'GPS Fleet Tracking',req:'Real-time NCC reporting',ghana:'Commercial GPS fleet systems available; active suppliers',fit:'★★★★☆'},
            {param:'Security Firms',req:'Licensed personnel; armed escort option',ghana:'Active cash-in-transit sector; established firms',fit:'★★★★☆'},
            {param:'Pharmaceutical Reefer',req:'Temperature-controlled vehicles',ghana:'Available from pharma logistics sector; leasing options',fit:'★★★☆☆'},
            {param:'Cannabis Manifest System',req:'NCC integration; chain-of-custody app',ghana:'No cannabis-specific system yet; B2B logistics apps adaptable',fit:'★★☆☆☆'},
          ].map((p,i) => (
...
const BusinessModels = () => {
  ...
  const models = [
    {
      n:'01',name:'Secure Cannabis Carrier',tag:'CORE MODEL',color:C.teal,
      tagline:'Licensed B2B. GPS-tracked. NCC-manifested. Serves all licence pairs.',
      scale:'2–5 vehicles · 1–3 routes/day per vehicle · 2-person crews',
      capital:'$50K–150K (2–3 vehicles retrofitted; GPS; NCC application)',
      timeline:'12–18 months to first revenue',
      revenue:'GH₵ 500–2,000 per trip (distance + weight dependent); contract retainers with anchor clients',
      fit:'★★★★☆ Entry model — serves cultivation, processing, testing, storage, export clients',
      description:'The secure cannabis carrier is the core Licence 07 business: a fleet of NCC-registered vehicles with locked cargo compartments, real-time GPS tracking, driver and security crew, and digital manifest capability integrated with the NCC track-and-trace system. Operating B2B between licensed facilities — cultivators, processors, testing labs, storage operators, exporters — this model generates per-trip fees from clients who cannot legally move product without a licensed transporter. Existing road-freight operators, logistics firms, or security companies can retrofit current vehicles and train existing staff to meet NCC requirements. This is the lowest-capital, fastest-to-market configuration.',
      requirements:['NCC Transportation Licence (Licence 07)','Vehicles with lockable, secure cargo compartments; tamper-evident seals','GPS fleet tracking — real-time reporting capability to NCC','Trained 2-person crews (driver + security) with NCC compliance training','Digital manifest system integrated with NCC track-and-trace'],
      advantages:['Mandatory demand from every cultivation, processing, and testing licence holder','No commodity ownership — zero crop failure or market price risk','Revenue scales directly with sector activity — more licences = more transport events','Existing logistics companies can enter with retrofit investment rather than new fleet purchase'],
      risks:['Revenue volume dependent on how many licences are active — low initial throughput in early sector years','Law enforcement confusion — cannabis transport vehicles may face roadside challenges despite NCC compliance','Fuel and maintenance costs are significant for long-haul cultivation zone routes'],
      ideal:'Existing road-freight operators or logistics SMEs adding cannabis to portfolio; security companies with vehicle fleets and personnel; investors seeking infrastructure play with zero commodity risk',
    },
    {
      n:'02',name:'Integrated Transport + Storage 3PL',tag:'VALUE-ADDED',color:C.forest,
      tagline:'Move it and store it. Combined Licence 06 + 07. Higher margin, stickier clients.',
      scale:'Fleet of 3–8 vehicles + climate-controlled storage hub · Tema or Kumasi base',
      capital:'$200K–600K (vehicle fleet + storage fit-out; combined 06+07 licences)',
      timeline:'18–30 months to full operation',
      revenue:'Transport fees + monthly storage fees; anchor client retainers; 30–50% margin improvement vs. transport-only',
      fit:'★★★★★ Highest revenue stickiness — combined model locks in clients across both services',
      description:'The integrated 3PL model combines NCC Licence 07 (Transportation) with Licence 06 (Storage) to offer clients a single end-to-end solution: collect from farm, deliver to storage hub, hold under climate-controlled conditions, deliver onward to processor, testing lab, or export port. This model creates much stronger client relationships than transport-only — a cultivator or processor with inventory in the storage hub uses the same operator for every movement. The combined revenue stream (transport fees + monthly storage fees) is more predictable and higher in aggregate than either service alone. This is the highest-value configuration for an operator who can afford combined capex.',
      requirements:['Both NCC Licence 07 (Transportation) and Licence 06 (Storage)','Climate-controlled storage hub at strategic location (Tema or Kumasi recommended)','Fleet of 3–8 vehicles with secure cargo compartments and GPS','Integrated WMS and transport management system covering both storage inventory and movement manifests','Single client interface — sales and account management serving both services'],
      advantages:['Stickier client relationships — clients tied in to both services','Combined per-client revenue is 2–3× transport-only model','Single compliance infrastructure serves both licences — efficiency gain on QA overhead','Market position as the only full-service cannabis logistics provider in Ghana creates significant competitive moat'],
      risks:['Higher combined capex — $200K–600K vs. $50K–150K for transport-only','More complex operations — requires competency in both vehicle logistics and climate-controlled warehousing','Longer timeline to full revenue — storage ramp-up adds 6–12 months vs. transport-only'],
      ideal:'Logistics companies with existing warehouse infrastructure; DFI-backed quality infrastructure investments; operators targeting anchor processing or exporting licence clients',
    },
    {
      n:'03',name:'Pharmaceutical GDP Distributor',tag:'HIGH-MARGIN SPECIALIST',color:C.ink,
      tagline:'GDP-compliant. Temperature-monitored. Medicinal cannabis and pharmaceutical distribution.',
      scale:'Reefer vehicles · validated cold chain · Accra–regional hospital and dispensary routes',
      capital:'$150K–400K (reefer vehicles; GDP certification; pharmaceutical logistics infrastructure)',
      timeline:'24–36 months (GDP certification adds time)',
      revenue:'GH₵ 2,000–8,000 per pharmaceutical shipment; GDP handling premium; monthly distribution contracts',
      fit:'★★★☆☆ Premium revenue — requires GDP certification investment',
      description:'The pharmaceutical GDP distributor focuses on temperature-controlled, documented movement of medicinal cannabis products — standardised extracts, APIs, and finished medicines — from processors to dispensaries, hospitals, and research facilities. GDP requirements mandate validated temperature monitoring, qualified carrier status, documented SOPs, and deviation management. This model leverages the same compliance infrastructure as general pharmaceutical distribution in Ghana, adding cannabis-specific NCC documentation requirements. Per-shipment fees are 3–5× higher than standard transport due to the compliance overlay and the high value of medicinal cannabis products. This configuration requires GDP certification — a separate process from NCC approval — but creates the highest per-trip margin in the transport category.',
      requirements:['NCC Transportation Licence (Licence 07) — pharmaceutical scope','Ghana FDA GDP certification for pharmaceutical distribution','Temperature-controlled vehicles: validated reefer or passive thermal packaging','GDP-compliant documentation: delivery records, temperature logs, deviation reports','Qualified person (QP) or responsible pharmacist for pharmaceutical distribution oversight'],
      advantages:['Highest per-shipment fee in transport category — pharmaceutical GDP rates are 3–5× standard','Natural extension for companies already in pharmaceutical distribution (GDP already in place)','Required by Licence 11 (Dispensing) holders who cannot receive medicinal stock without GDP-compliant transport','EU/pharmaceutical export pathway: GDP-compliant distribution chain is prerequisite for pharmaceutical export recognition'],
      risks:['GDP certification process is lengthy and expensive — 18–24 months from initiation','Requires qualified pharmaceutical person — hard to recruit and retain in Ghana','Revenue fully dependent on Licence 02 (Processing) producing pharmaceutical-grade outputs'],
      ideal:'Pharmaceutical distribution companies adding cannabis to portfolio; DFI-backed healthcare logistics; operators who already hold GDP status for other pharmaceutical products in Ghana',
    },
    {
      n:'04',name:'Export Port Specialist',tag:'TEMA-BASED',color:C.limeDark,
      tagline:'Port-to-processor, processor-to-port. Export documentation + customs coordination.',
      scale:'Tema port cluster base · 2–4 vehicles · customs broker partnership',
      capital:'$80K–200K (port-adjacent base; 2–4 vehicles; customs brokerage partnership)',
      timeline:'12–18 months to first revenue',
      revenue:'GH₵ 1,500–5,000 per export shipment movement; customs coordination premium',
      fit:'★★★☆☆ Essential for Licence 09 export clients; port-adjacent premium pricing',
      description:'The export port specialist operates a Tema-based transport service focused specifically on the final movement from inland storage or processing to container loading at Tema port, managing NCC chain-of-custody handover, customs clearance coordination, and export documentation. Tema port handles 85% of Ghana national trade — a single point of entry and exit for hemp fibre bales, seed oil, extracts, and pharmaceutical products destined for EU and UK markets. The export specialist charges a premium for port-adjacent service, fast turnaround, and expertise in customs procedures for cannabis-classified goods. Partnership with a customs broker with NCC cannabis experience is the key differentiator.',
      requirements:['NCC Transportation Licence (Licence 07) — export movement scope','Tema port operating permit or registered haulier status','Partnership with Ghana Revenue Authority-registered customs broker with cannabis product experience','Secure vehicle with tamper-evident seals for port customs inspection','Export documentation management: phytosanitary certificates, certificates of origin, COAs, NCC export authorisation'],
      advantages:['Port proximity reduces transit time — critical for export documentation deadlines','Tema EPZ and Free Zone client base provides natural anchor clients in export community','First mover in cannabis export logistics captures all early export licence holders who have no alternative','Premium per-shipment pricing for port-specialist expertise and proximity'],
      risks:['Revenue concentrated on export sector volume — slow if early export licences are few','Port operations are subject to congestion and customs delays outside the transporter control','Requires formal Tema port operating permit separate from NCC licence'],
      ideal:'Tema-based logistics operators; freight forwarders adding cannabis to existing portfolio; companies with established Ghana Ports Authority relationships',
    },
  ];
  ...
  return (
    <div id="s04" className="pad-section" style={{background:C.paperDark,padding:'56px 64px'}}>
      <div style={{maxWidth:'900px',margin:'0 auto'}}>
        <MobileCollapse num="§ 04" title="Business Models" stat="4 Models" label="$50K to $600K Entry">
        <SectionRule/>
        <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
        ...
        <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'28px',maxWidth:'680px'}}>Four Cannabis Transport Configurations — from Local Carrier to GDP Distributor</h2>
        {/* Model tabs */}
        {/* Desktop tab row */}
...
const UnitEconomics = () => (
  <div id="s05" className="pad-section" style={{background:C.paper,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 05" title="Unit Economics" stat="GH₵500–8K" label="Per Trip Range">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'12px',maxWidth:'680px'}}>What Cannabis Transport Revenue Looks Like Per Trip and Per Vehicle</h2>
      <p style={{fontFamily:F.body,fontSize:'15px',fontWeight:300,lineHeight:1.85,color:C.ink,marginBottom:'36px',maxWidth:'700px'}}>
        Transport economics are driven by trip frequency, distance, and the premium charged for cannabis compliance. Cannabis transport commands 2–4× the per-km rate of general freight — reflecting compliance overhead, security crew cost, and the mandatory nature of the service for all licence holders.
      </p>
      <div style={{background:C.paperDark,padding:'28px',marginBottom:'32px'}}>
        <Eyebrow>Revenue Per Trip · 4 Route Types (GH₵)</Eyebrow>
        <div style={{marginTop:'18px'}}>
          {[
            {label:'Short-haul: farm to processor (50–100km)',v:15,max:80,note:'GH₵ 500–1,500 per trip — high frequency, standard biomass'},
            {label:'Mid-haul: processing zone to Tema (150–300km)',v:35,max:80,note:'GH₵ 1,000–3,000 per trip — processed product, export staging'},
            {label:'Long-haul: northern zones to Tema (400–600km)',v:55,max:80,note:'GH₵ 2,000–5,000 per trip — premium for distance and security challenge'},
            {label:'Pharmaceutical GDP shipment (any distance)',v:75,max:80,note:'GH₵ 2,000–8,000 per trip — GDP compliance premium'},
          ].map((s,i) => (
            <div key={i} style={{marginBottom:'14px'}}>
              <div style={{display:'flex',justifyContent:'space-between',marginBottom:'4px',flexWrap:'wrap',gap:'6px'}}>
                ...
                <span style={{fontFamily:F.mono,fontSize:'13px',fontWeight:700,color:C.forest}}>GH₵{s.v*100}+</span>
              </div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'24px',marginBottom:'32px'}} className="tc">
        <div>
          <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.muted,marginBottom:'12px'}}>Revenue Scenarios at Different Fleet Scale</div>
          {[
            {item:'2-vehicle fleet — 3 trips/day each',range:'$4K–8K/mo',pct:'Entry phase',note:'Short-haul routes; 6 daily trips; anchor client contracts'},
            {item:'5-vehicle fleet — mixed routes',range:'$15K–35K/mo',pct:'Growth phase',note:'Short + mid-haul mix; 15–20 daily trips at Phase 2'},
            {item:'10-vehicle fleet — full coverage',range:'$35K–80K/mo',pct:'Scale',note:'All corridor coverage; 40+ daily trips; anchor processing clients'},
            {item:'GDP pharma route (2 dedicated vehicles)',range:'$10K–25K/mo',pct:'Premium',note:'Pharmaceutical shipments at 3–5× standard rate'},
            {item:'Port specialist (2 vehicles, Tema-based)',range:'$8K–20K/mo',pct:'Port-adjacent',note:'Export staging; port coordination premium per shipment'},
            {item:'3PL combined (transport + storage)',range:'$25K–60K/mo',pct:'Integrated',note:'Combined Licence 06+07 monthly fees from anchor clients'},
          ].map((r,i) => (
        ...
        <div>
          <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.muted,marginBottom:'12px'}}>Operating Cost Per Vehicle Per Month</div>
          <div style={{background:C.ink,padding:'20px',marginBottom:'16px'}}>
            <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.lime,marginBottom:'14px'}}>Cost Breakdown — Secure Cannabis Transport Vehicle</div>
            {[
              {scale:'Fuel (high-utilisation route coverage)', capex:'$400–800/mo', note:'Primary variable cost; long-haul routes most significant'},
              {scale:'Driver + security crew salary', capex:'$600–1,200/mo', note:'2-person crew standard; NCC compliance training required'},
              {scale:'Vehicle maintenance + insurance', capex:'$200–500/mo', note:'Secure cargo modification increases insurance cost vs. standard freight'},
              {scale:'GPS tracking + manifest software', capex:'$50–150/mo', note:'Per-vehicle SaaS subscription for fleet management + NCC reporting'},
            ].map((r,i) => (
          ...
          <div style={{border:`1px solid ${C.border}`,padding:'16px'}}>
            ...
            <p style={{fontFamily:F.body,fontSize:'12px',lineHeight:1.7,color:C.ink,marginBottom:'10px'}}>A 3-vehicle fleet running 4–5 trips per day at average GH₵ 1,200 per trip generates ~$15K–25K/month in gross revenue against ~$6K–10K in operating costs per month. Operating breakeven typically occurs within <strong>12–18 months</strong> of NCC licence.</p>
            <p style={{fontFamily:F.body,fontSize:'12px',lineHeight:1.7,color:C.ink,marginBottom:'10px'}}>Capital payback on vehicle retrofit and compliance setup ($50K–150K) within <strong>18–30 months</strong> with anchor client contracts. The key driver is client volume — secure anchor agreements before fleet purchase.</p>
            <div style={{borderLeft:`2px solid ${C.lime}`,paddingLeft:'10px'}}>
              <p style={{fontFamily:F.body,fontSize:'11px',fontStyle:'italic',color:C.forest,lineHeight:1.6}}>✓ Transport has zero commodity risk. The transporter does not own the product — they charge a compliance fee for every movement regardless of cannabis market prices.</p>
            </div>
          </div>
        </div>
      </div>
...
const ValueChainPosition = () => {
  ...
  const chainItems = [
    {num:'01',name:'Cultivation',pos:'UPSTREAM',color:C.forest,rel:'ORIGIN'},
    {num:'03',name:'Breeding & Seed',pos:'UPSTREAM',color:C.teal,rel:'SHIPS SEED'},
    {num:'05',name:'Testing Lab',pos:'ENABLING',color:C.limeDark,rel:'DELIVERS SAMPLES'},
    {num:'07',name:'Transport',pos:'ENABLING',color:C.lime,rel:null,active:true},
    {num:'06',name:'Storage',pos:'ENABLING',color:C.limeDark,rel:'DELIVERS TO'},
    {num:'02',name:'Processing',pos:'MID-CHAIN',color:C.forest,rel:'DELIVERS TO'},
    {num:'08',name:'Import',pos:'TRADE',color:C.teal,rel:'CLEARS PORT'},
    {num:'09',name:'Export',pos:'TRADE',color:C.teal,rel:'DELIVERS TO PORT'},
    {num:'10',name:'Wholesale',pos:'MID-CHAIN',color:C.forest,rel:'DISTRIBUTES'},
    {num:'11',name:'Dispensing',pos:'DOWNSTREAM',color:C.forest,rel:'FINAL MILE'},
  ];
  ...
  <div id="s06" className="pad-section" style={{background:C.paperDark,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 06" title="Value Chain" stat="10 of 11" label="Licences Need a Transporter">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'28px',maxWidth:'680px'}}>The Movement Node — Between Every Pair of Licences That Exchange Product</h2>
      {/* Chain visual */}
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'24px'}} className="tc">
        <div>
          <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.muted,marginBottom:'12px'}}>Key Movements the Transporter Facilitates (Upstream)</div>
          {[
            {lic:'Licence 01 → 05 (Testing Lab)',role:'Pre-harvest samples collected from farm and delivered to testing lab. Time-sensitive — samples must arrive within defined window for THC result before harvest date.'},
            {lic:'Licence 01 → 02 (Processing)',role:'Post-harvest biomass from farm to processor. Primary high-volume movement. Cultivator cannot be paid until biomass is delivered and weighed.'},
            {lic:'Licence 01 → 06 (Storage)',role:'Cultivator excess production to bonded storage. Enables cultivators to time sales without distressed post-harvest pricing.'},
            {lic:'Licence 08 (Import) → 01/03',role:'Imported certified seed delivered from port to cultivation or breeding sites. Inbound movement at sector launch — immediate demand.'},
          ].map((r,i) => (
        ...
        <div>
          <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'2px',textTransform:'uppercase',color:C.muted,marginBottom:'12px'}}>Key Movements the Transporter Facilitates (Downstream)</div>
          {[
            {lic:'Licence 02 → 09 (Export)',role:'Processed product from processor to Tema or Takoradi port for export. High-value cargo; port documentation and customs coordination required.'},
            {lic:'Licence 02 → 11 (Dispensing)',role:'Medicinal cannabis product from processor to licensed dispensary. GDP-compliant cold-chain transport; pharmaceutical documentation per shipment.'},
            {lic:'Licence 06 → 02/09',role:'Inventory withdrawal from storage to processor or export staging. Storage operator calls the transporter — recurring operational relationship.'},
            {lic:'Cross-border ECOWAS',role:'Hemp fibre, seed, and oil movements to West African neighbours as their licensing regimes develop. Ghana as regional logistics hub.'},
          ].map((r,i) => (
            <div key={i} style={{padding:'10px 0',borderBottom:`1px solid ${C.border}`}}>
...
const CompetitiveLandscape = () => (
  <div id="s07" className="pad-section" style={{background:C.paper,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 07" title="Competition" stat="0" label="Licensed Cannabis Transporters">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'28px',maxWidth:'680px'}}>Ghana vs. Seven African Peers — Cannabis Logistics Infrastructure</h2>
      {/* Desktop table */}
      <div className="mob-hide" style={{overflowX:'auto'}}>
        <table style={{width:'100%',borderCollapse:'collapse',minWidth:'680px'}}>
          <thead>
            <tr style={{background:C.ink}}>
              {['Country','Status','Licensed Carriers','Logistics Base','Port Access','Framework','BRIDGE View'].map((h,i) => (
          ...
          <tbody>
            {[
              {country:'🇬🇭 Ghana',status:'Active 2026',aFit:'★☆☆☆☆ — Zero licensed',port:'★★★★★ — Tema dominant hub',labour:'★★★★★ — Port logistics cluster',fw:'★★★☆☆ — NCC L.I. 2475',view:'Zero licensed cannabis carriers — first operator captures mandatory movement market',hl:true},
              {country:'🇿🇦 South Africa',status:'Active 2023',aFit:'★★★★☆ — Carriers active',port:'★★★★☆ — Durban + Cape Town',labour:'★★★★☆',fw:'★★★★★',view:'Most developed cannabis transport in Africa; GDP-compliant pharmaceutical carriers active'},
              {country:'🇱🇸 Lesotho',status:'Active 2017',aFit:'★★☆☆☆ — On-site mainly',port:'★☆☆☆☆ — Landlocked',labour:'★★★☆☆',fw:'★★★★☆',view:'Medicinal export only; transport relies on SA logistics for cross-border movement'},
              {country:'🇰🇪 Kenya',status:'Emerging 2023',aFit:'★★☆☆☆ — Building',port:'★★★☆☆ — Mombasa',labour:'★★★☆☆',fw:'★★☆☆☆',view:'Mombasa port logistics base; developing cannabis transport but no stand-alone licence yet'},
              {country:'🇲🇦 Morocco',status:'Recent 2021',aFit:'★★★☆☆ — Pharma carriers',port:'★★★★☆ — EU ports',labour:'★★★☆☆',fw:'★★★☆☆',view:'Pharma logistics network strong for EU access; cannabis-specific transport regulations limited'},
              {country:'🇿🇼 Zimbabwe',status:'Active 2022',aFit:'★★☆☆☆ — On-site',port:'★☆☆☆☆ — Landlocked',labour:'★★☆☆☆',fw:'★★☆☆☆',view:'On-site transport only; severe landlocked logistics challenge for exports'},
              {country:'🇲🇼 Malawi',status:'Active 2020',aFit:'★☆☆☆☆ — Minimal',port:'★☆☆☆☆ — Landlocked',labour:'★★☆☆☆',fw:'★★☆☆☆',view:'No dedicated cannabis transport; landlocked and logistics infrastructure is weak'},
              {country:'🇿🇲 Zambia',status:'Emerging',aFit:'★☆☆☆☆ — None',port:'★★☆☆☆',labour:'★☆☆☆☆',fw:'★★☆☆☆',view:'No cannabis transport infrastructure; framework still developing'},
            ].map((r,i) => (
      ...
      <MobCountryCards countries={[
        {country:'🇬🇭 Ghana',status:'Active 2026',aFit:'★☆☆☆☆ — Zero licensed',port:'★★★★★ — Tema hub',labour:'★★★★★ — Port cluster',fw:'★★★☆☆',view:'First licensed cannabis carrier captures entire mandatory transport market.',hl:true},
        {country:'🇿🇦 South Africa',status:'Active 2023',aFit:'★★★★☆ — Carriers active',port:'★★★★☆ — Durban',labour:'★★★★☆',fw:'★★★★★',view:'Most developed cannabis transport; GDP-compliant pharmaceutical carriers active'},
        {country:'🇱🇸 Lesotho',status:'Active 2017',aFit:'★★☆☆☆ — On-site',port:'★☆☆☆☆ — Landlocked',labour:'★★★☆☆',fw:'★★★★☆',view:'Medicinal export only; relies on SA for cross-border logistics'},
        {country:'🇰🇪 Kenya',status:'Emerging 2023',aFit:'★★☆☆☆ — Building',port:'★★★☆☆ — Mombasa',labour:'★★★☆☆',fw:'★★☆☆☆',view:'Mombasa port base; no stand-alone cannabis transport licence yet'},
        {country:'🇲🇦 Morocco',status:'Recent 2021',aFit:'★★★☆☆ — Pharma carriers',port:'★★★★☆ — EU access',labour:'★★★☆☆',fw:'★★★☆☆',view:'Pharma logistics strong for EU; cannabis-specific rules limited'},
        {country:'🇿🇼 Zimbabwe',status:'Active 2022',aFit:'★★☆☆☆ — On-site',port:'★☆☆☆☆ — Landlocked',labour:'★★☆☆☆',fw:'★★☆☆☆',view:'On-site only; severe landlocked challenge for exports'},
        {country:'🇲🇼 Malawi',status:'Active 2020',aFit:'★☆☆☆☆ — Minimal',port:'★☆☆☆☆ — Landlocked',labour:'★★☆☆☆',fw:'★★☆☆☆',view:'No cannabis transport; landlocked infrastructure weakness'},
        {country:'🇿🇲 Zambia',status:'Emerging',aFit:'★☆☆☆☆ — None',port:'★★☆☆☆',labour:'★☆☆☆☆',fw:'★★☆☆☆',view:'No cannabis transport infrastructure'},
      ]}/>
      <PullQuote>
        Ghana's Tema port handles 85% of national trade. The Tema–Ouagadougou corridor is West Africa's most active transit route. A licensed cannabis transporter in Ghana occupies the logistics node of the continent's most active cannabis-enabled trade corridor — and has zero competition on Day 1.
      </PullQuote>
      <div style={{background:C.paperDark,padding:'20px',marginTop:'8px'}}>
        <Eyebrow>Ghana Transport Structural Advantages</Eyebrow>
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'0',marginTop:'14px'}} className="tc3">
          {[
            {title:'Existing Logistics Ecosystem',body:'Dense road-freight network, established pharmaceutical distribution chains, port-logistics operators, and private security escort firms already operational. Cannabis transport layers compliance on an existing capable logistics foundation — not built from scratch.'},
            {title:'Tema Port Gateway',body:'85% of Ghana national trade and all ECOWAS landlocked country transit flows through Tema. Every hemp export shipment passes through Tema. A licensed cannabis carrier based at Tema captures every export movement in the sector.'},
            {title:'Zero Incumbent Advantage',body:'There are no licensed cannabis transporters in Ghana. Every cultivation, processing, testing, storage, and export licence holder needs transport. The first NCC Licence 07 holder faces zero competition for the entire mandatory transport market.'},
          ].map((a,i) => (
...
const RegulatoryRoadmap = () => (
  <div id="s08" className="pad-section" style={{background:C.paperDark,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 08" title="Regulatory Roadmap" stat="5 Phases" label="to First Manifest Issued">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'28px',maxWidth:'680px'}}>From NCC Application to First Cannabis Shipment Manifest</h2>
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'40px'}} className="tc mob-hide">
        <div>
          {[
            {phase:'Phase 1',label:'Vehicle Selection & Compliance Upgrade (Months 1–3)',steps:['Identify vehicle type for primary routes: enclosed van or truck for biomass; reefer for pharmaceutical scope','Install secure lockable cargo compartment — purpose-designed or fabricated; tamper-evident seal capability','Install GPS fleet tracking unit with real-time reporting capability; select NCC-compatible fleet management software','Install alarm system, immobiliser, and interior camera for cargo monitoring','Engage NCC Cannabis Regulations Department for pre-application consultation on vehicle and crew requirements'],color:C.teal},
            {phase:'Phase 2',label:'NCC Licence Application (Months 2–5)',steps:['Submit NCC Transportation Licence (Licence 07) application: vehicle details, GPS system documentation, security plan, crew training certificates','Document chain-of-custody and manifest procedures for NCC review','Enrol drivers and security crew in NCC compliance training — cannabis handling, documentation, law enforcement liaison','Apply for DVLA commercial vehicle endorsement or any additional vehicle permits required for cannabis transport','For pharmaceutical scope: initiate Ghana FDA GDP carrier application (parallel process to NCC)'],color:C.forest},
            {phase:'Phase 3',label:'NCC Approval & System Integration (Months 4–8)',steps:['NCC vehicle inspection: cargo security, GPS, documentation capability assessed','Address any vehicle modifications or documentation gaps identified in NCC review','Integrate GPS fleet management system with NCC track-and-trace reporting platform','Deploy digital manifest system for drivers: NCC-format chain-of-custody, signature capture, incident reporting','Formalise private security partnership for 2-person crew and armed escort capability where required'],color:C.limeDark},
            {phase:'Phase 4',label:'Commercial Operations Launch (Months 8–14)',steps:['Sign anchor client contracts with Licence 01 cultivators and Licence 02 processors before or at launch','Conduct first client onboarding: chain-of-custody procedures, manifest preparation, handoff protocols','Execute first licensed cannabis transport — pilot route with full documentation and NCC reporting','File first movement reports to NCC — batch ID, origin, destination, weight, product type, COA reference','Develop emergency response protocol: theft, accident, law enforcement stop — documented and rehearsed'],color:C.amber},
            {phase:'Phase 5',label:'Fleet Expansion & GDP Scope (Months 14+)',steps:['Add vehicles as client volume grows — deploy before demand exceeds capacity to avoid client loss','Add pharmaceutical GDP scope if carrying medicinal cannabis products — reefer vehicles + GDP documentation','Develop temperature-controlled capability for extract and pharmaceutical transport routes','Engage Tema EPZ-based exporters as anchor clients for port-logistics services','Annual NCC compliance review: vehicle registry, manifest records, incident reports, GPS data retention'],color:C.lime},
          ].map((p,i) => (
        ...
        <div>
          <div style={{background:C.ink,padding:'22px',marginBottom:'20px'}}>
            ...
            {[
              {item:'NCC transport licence renewal',detail:'Every 3 years; vehicle registry, driver and crew list, GPS systems re-registered'},
              {item:'Manifest records retention',detail:'All movement manifests retained minimum 5 years; available for NCC audit on demand'},
              {item:'GPS tracking data retention',detail:'Vehicle location data retained per NCC requirements; route deviation logs available'},
              {item:'Vehicle inspection compliance',detail:'Annual DVLA commercial vehicle inspection; NCC security feature audit; GPS calibration'},
              {item:'Driver and crew records',detail:'Background checks renewed; training certificates current; authorised personnel list maintained'},
              {item:'Incident reporting',detail:'Theft, tampering, accident, law enforcement seizure — NCC notification required within defined timeframe'},
              {item:'GDP revalidation (if applicable)',detail:'Ghana FDA GDP carrier assessment; temperature monitoring calibration; SOP review'},
            ].map((r,i) => (
          ...
          <div style={{border:`1px solid ${C.border}`,padding:'18px',marginBottom:'16px'}}>
            ...
            {[
              {body:'DVLA (Driver and Vehicle Licensing Authority)',role:'Commercial vehicle licence, endorsements for special cargo; roadworthiness certification'},
              {body:'Ghana Police Service',role:'Law enforcement liaison for cannabis transport; roadside stop procedures; incident reporting'},
              {body:'Ghana Revenue Authority',role:'Customs documentation for cross-border hemp movements; import duty on vehicle upgrades'},
              {body:'Ghana FDA',role:'GDP carrier certification for pharmaceutical cannabis distribution; deviation management requirements'},
              {body:'Ministry of the Interior',role:'Private security firm licensing for armed escort capability; security personnel permits'},
            ].map((r,i) => (
          ...
          <div style={{borderLeft:`3px solid ${C.amber}`,paddingLeft:'14px',background:C.paper,padding:'14px 14px 14px 16px'}}>
            <div style={{fontFamily:F.sans,fontSize:'9px',fontWeight:700,letterSpacing:'1.5px',textTransform:'uppercase',color:C.amber,marginBottom:'6px'}}>Law Enforcement Encounter Protocol — Critical Operational Risk</div>
            <p style={{fontFamily:F.body,fontSize:'12px',lineHeight:1.65,color:C.ink}}>Despite NCC compliance, cannabis transport vehicles may be stopped by Ghana Police Service officers unfamiliar with the new licensing regime. <strong>Every driver must carry: (1) original NCC Licence 07 certificate, (2) current shipment manifest, (3) product COA from Licence 05 lab, (4) NCC emergency contact details. Drivers must be trained to remain calm, present documentation, and call the NCC hotline immediately if product is seized. Pre-notify Ghana Police Service regional headquarters before first commercial operations.</strong></p>
          </div>
        </div>
      </div>
      <MobPhaseAccordion phases={[
        {phase:'Phase 1',label:'Vehicle Compliance Upgrade (Months 1–3)',color:C.teal,steps:['Select vehicle type for primary routes','Install secure lockable cargo compartment with tamper-evident seals','Install GPS fleet tracking with NCC-compatible reporting','Install alarm system, immobiliser, interior camera','NCC pre-application consultation']},
        {phase:'Phase 2',label:'NCC Application (Months 2–5)',color:C.forest,steps:['Submit NCC Licence 07 application with vehicle details and GPS documentation','Document chain-of-custody and manifest procedures','Enrol drivers and crew in NCC compliance training','DVLA commercial vehicle endorsement','GDP carrier application if pharmaceutical scope']},
        {phase:'Phase 3',label:'NCC Approval & System (Months 4–8)',color:C.limeDark,steps:['NCC vehicle inspection: cargo security, GPS, documentation','Address modifications identified in NCC review','Integrate GPS with NCC track-and-trace platform','Deploy digital manifest system for drivers','Formalise private security partnership for 2-person crews']},
        {phase:'Phase 4',label:'Commercial Launch (Months 8–14)',color:C.amber,steps:['Sign anchor client contracts pre-launch','Client onboarding: chain-of-custody and manifest procedures','Execute first licensed cannabis transport','File first movement reports to NCC','Rehearse emergency response protocol']},
        {phase:'Phase 5',label:'Fleet Expansion & GDP (Months 14+)',color:C.lime,steps:['Add vehicles as client volume grows','Add pharmaceutical GDP scope if carrying medicinal products','Deploy temperature-controlled reefer vehicles','Engage Tema EPZ exporters as anchor clients','Annual NCC compliance review']},
      ]}/>
    </MobileCollapse>
    </div>
  </div>
...
const RiskRegister = () => {
  ...
  const risks = [
          {
            r:'Law enforcement confusion — cannabis transport vehicles stopped and product seized despite NCC compliance',
            sev:'HIGH',likelihood:'Medium-High (in early sector)',cat:'Operational / Legal',
            m:'Ghana Police Service officers not yet familiar with NCC cannabis licensing regime may treat compliant transport as illegal. Mitigation: (1) Pre-notify Ghana Police Service regional headquarters before commercial operations begin. (2) Every driver carries original NCC Licence 07, current manifest, product COA, and NCC emergency contact. (3) Train all drivers on calm and cooperative law enforcement liaison protocol. (4) NCC to issue law enforcement guidance letter. This risk diminishes as the sector matures but is acute in the first 12–24 months.',
          },
          {
            r:'Theft of high-value cannabis cargo in transit',
            sev:'HIGH',likelihood:'Low-Medium (with proper security)',cat:'Security / Financial',
            m:'Two-person crews are standard in regulated markets — driver plus security. Route randomisation for high-value loads. GPS geofencing and real-time monitoring with panic button and escalation protocol. Relationships with private security firms for armed escort on high-risk routes (northern zones especially). Cargo insurance from Day 1 — cannabis product is high-value and uninsured loss can be catastrophic. Strict access controls on cargo compartment throughout journey.',
          },
          {
            r:'Low initial client volume — insufficient sector activity for fleet profitability',
            sev:'MEDIUM-HIGH',likelihood:'Medium (Year 1)',cat:'Commercial',
            m:'Anchor client contracts before fleet purchase. Minimum volume commitments in client agreements. Multi-sector strategy: FMCG, pharmaceutical, and high-value food transport using same compliant fleet when cannabis loads are insufficient. Private sector pharmaceutical GDP transport generates premium per-trip revenue from Day 1 regardless of cannabis sector pace. 2–3 vehicle minimum viable fleet — do not over-invest in vehicles before demand is confirmed.',
          },
          {
            r:'NCC track-and-trace manifest system not yet operational',
            sev:'MEDIUM',likelihood:'Medium (framework still being built)',cat:'Regulatory / Technology',
            m:'Engage NCC Cannabis Regulations Department during application process to understand current manifest requirements. Design digital manifest system with flexible integration architecture — can connect to multiple platforms. Paper manifests with NCC-format documentation may be acceptable during system build-out period. Build NCC reporting system integration as a post-launch upgrade rather than a launch blocker.',
          },
          {
            r:'Fuel cost volatility — transport economics sensitive to fuel price changes',
            sev:'MEDIUM',likelihood:'Medium (Ghana fuel pricing history)',cat:'Financial',
            m:'Fuel surcharge clause in all client contracts — fuel cost above agreed baseline triggers automatic surcharge. Route efficiency optimisation to reduce fuel consumption per km. Fuel hedging through advance purchase agreements where available. Northern zone long-haul routes are most exposed — price accordingly with distance-based premium tariffs.',
          },
          {
            r:'Vehicle breakdown — transport delay causes client product quality loss',
            sev:'MEDIUM',likelihood:'Low-Medium (with maintenance)',cat:'Operational',
            m:'Preventive maintenance schedule for all vehicles. Breakdown cover with roadside assistance nationally. Backup vehicle arrangement with trusted freight partner for emergency coverage. Client SLA specifies maximum acceptable delay times and compensation for delays beyond transporter control. Cannabis biomass delay risk is higher in high-temperature conditions — prioritise fast response in dry/hot seasons.',
          },
          {
            r:'GDP certification timeline — pharmaceutical scope delayed by Ghana FDA process',
            sev:'LOW-MEDIUM',likelihood:'Medium (for pharmaceutical model)',cat:'Regulatory',
            m:'Initiate Ghana FDA GDP carrier application in parallel with NCC Licence 07 application — not sequentially. Engage a GDP consultant with knowledge of Ghana FDA pharmaceutical distribution requirements. Launch with standard NCC transport scope initially; add GDP as a scope extension once certification is received. Not a blocker for launch — pharmaceutical clients can use interim arrangements while GDP is obtained.',
          },
          {
            r:'Cross-border ECOWAS cannabis transport — legal uncertainty in transit countries',
            sev:'LOW-MEDIUM',likelihood:'Low (early sector)',cat:'Legal / Regulatory',
            m:'Do not attempt cross-border cannabis transport without explicit legal analysis for each transit country. ECOWAS countries have divergent cannabis laws — transit through a non-licensing country creates seizure risk even for compliant Ghana product. Focus on domestic transport in Years 1–3. Engage ECOWAS legal counsel before any cross-border movement is attempted. Monitor ECOWAS cannabis law developments and activate regional capacity when legal clarity is established.',
          },
  ];
  return (
...
const BridgeScore = () => {
  ...
  const dims = [
    {dim:'Market Opportunity',score:60,weight:'30%',rationale:'Mandatory demand from every licence holder pair that exchanges product. No commodity risk — transporter charges for movement regardless of product value. Revenue scales with sector activity. Score bounded by early-sector volume — few licences in Year 1 means few trips. Multi-sector freight capability improves utilisation significantly.'},
    {dim:'Development Impact',score:55,weight:'30%',rationale:'Transportation creates logistics employment across Ghana supply chain — drivers, security crew, dispatchers, compliance staff. But the employment intensity per GH₵ invested is lower than cultivation. Impact is enabling: without compliant transport the entire sector cannot function, but the direct employment creation is moderate.'},
    {dim:'Implementation Feasibility',score:72,weight:'25%',rationale:'Ghana has a well-developed road freight ecosystem, established security firms, GPS fleet systems, and pharmaceutical distribution chains. Retrofitting existing vehicles is significantly cheaper than building from scratch. Law enforcement confusion is a real near-term challenge but is manageable with NCC pre-notification. Overall high feasibility.'},
    {dim:'Financial Sustainability',score:68,weight:'15%',rationale:'Recurring per-trip revenue from confirmed clients, no commodity ownership risk, and fuel cost management through surcharge clauses create a resilient financial model. Multi-sector freight diversification provides baseline utilisation. Capital payback within 18–30 months with anchor client contracts is achievable.'},
  ];
  return (
  <div id="s10" className="pad-section" style={{background:C.ink,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 10" title="BRIDGE Score™" stat="63/100" label="Emerging Tier · Enabling" onDark={true}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.paper,lineHeight:1.2,marginBottom:'32px',maxWidth:'680px'}}>Transportation Scores 63/100 — Zero Commodity Risk, Mandatory Demand, Law Enforcement Challenge</h2>
      <div style={{display:'grid',gridTemplateColumns:'1fr 1.4fr',gap:'40px'}} className="tc">
        <div>
          ...
          <div style={{display:'flex',alignItems:'baseline',gap:'6px',marginBottom:'4px'}}>
            <div style={{fontFamily:F.mono,fontSize:'clamp(72px,12vw,120px)',fontWeight:500,color:C.lime,lineHeight:1}}>63</div>
          ...
          <div style={{fontFamily:F.sans,fontSize:'10px',color:'rgba(250,248,243,0.28)',letterSpacing:'0.5px',marginBottom:'28px'}}>Emerging Tier · Enabling · NCC Licence 07</div>
          <ScoreBar label="Market Opportunity  ×30%" value={60} onDark/>
          <ScoreBar label="Development Impact  ×30%" value={55} onDark/>
          ...
          <div style={{marginTop:'20px',borderTop:`1px solid rgba(255,255,255,0.08)`,paddingTop:'16px'}}>
            ...
            {[{l:'Entry Barrier',v:'Medium (retrofit) to Medium-High'},{l:'Capital Intensity',v:'Medium ($50K–600K)'},{l:'Timeline to Revenue',v:'12–18 months'},{l:'Licence Tier',v:'Emerging · Enabling'}].map((p,i) => (
...
const Deployment = () => {
  ...
  const capRows = [
    {cat:'NCC Transportation Licence (Licence 07)',range:'$2K–8K',note:'Application + 3-year licence; confirm fee schedule with NCC'},
    {cat:'Vehicle purchase or lease (per vehicle)',range:'$15K–50K',note:'Enclosed van or truck; lease option reduces upfront capital'},
    {cat:'Cargo security compartment modification',range:'$2K–8K/vehicle',note:'Lockable, secure cargo area; tamper-evident seal hardware'},
    {cat:'GPS fleet tracking hardware + installation',range:'$500–2K/vehicle',note:'Real-time GPS; monthly SaaS subscription for fleet management'},
    {cat:'Alarm system + immobiliser',range:'$500–1.5K/vehicle',note:'Vehicle security; NCC compliance requirement'},
    {cat:'Digital manifest + NCC reporting software',range:'$3K–10K',note:'Driver app + dispatcher platform + NCC integration capability'},
    {cat:'Cannabis transport insurance',range:'$3K–12K/yr',note:'Commercial vehicle + cargo insurance for cannabis-classified goods'},
    {cat:'Driver and crew NCC training',range:'$500–2K/person',note:'NCC compliance training, law enforcement liaison protocol'},
    {cat:'Working capital (12 months)',range:'$15K–50K',note:'Fuel, maintenance, crew salaries pre-revenue or pre-breakeven'},
  ];
  const SHOW_FIRST = 4;
  return (
  <div id="s11" className="pad-section" style={{background:C.paperDark,padding:'56px 64px'}}>
    <div style={{maxWidth:'900px',margin:'0 auto'}}>
      <MobileCollapse num="§ 11" title="Deployment" stat="$50K+" label="Minimum Entry — 2 Vehicles">
      <SectionRule/>
      <div style={{display:'flex',gap:'4px',alignItems:'center',marginBottom:'8px'}}>
      ...
      <h2 style={{fontFamily:F.display,fontSize:'clamp(22px,3vw,38px)',fontWeight:700,color:C.ink,lineHeight:1.2,marginBottom:'28px',maxWidth:'680px'}}>What It Takes to Launch Ghana's First Licensed Cannabis Transport Operation</h2>
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'28px',marginBottom:'32px'}} className="tc">
        ...
        <div>
          ...
          <div style={{border:`1px solid ${C.border}`,padding:'20px',marginBottom:'20px'}}>
            ...
            {[
              {role:'Transport Manager / Dispatcher',spec:'Fleet operations; route planning; client scheduling; NCC manifest oversight'},
              {role:'NCC Compliance Officer',spec:'Licence documentation; manifest records; NCC reporting; incident management'},
              {role:'Licensed Driver ×2',spec:'NCC-trained; cannabis transport protocols; law enforcement liaison procedures'},
              {role:'Security Personnel ×2',spec:'Cargo security; armed or unarmed escort per route risk assessment; incident response'},
              {role:'Finance / Client Services',spec:'Client invoicing; contract management; fuel cost tracking; NCC licence renewal'},
            ].map((r,i) => (
          ...
          <div style={{background:C.ink,padding:'20px'}}>
            ...
            <p style={{fontFamily:F.body,fontSize:'13px',fontWeight:300,color:'rgba(250,248,243,0.7)',lineHeight:1.75,marginBottom:'12px'}}>
              Ghana's first cannabis harvests are expected within 3–6 months of cultivation licences being granted. Every kilogram harvested must be transported to a processor — and no licensed cannabis transporters exist. The operator who achieves NCC Licence 07 before the first harvest season captures an uncontested mandatory-demand market.
            </p>
            <p style={{fontFamily:F.body,fontSize:'13px',fontWeight:300,color:'rgba(250,248,243,0.7)',lineHeight:1.75,marginBottom:'16px'}}>
              The 12-month vehicle compliance and NCC approval timeline means operators who begin now will be operational before the first major cannabis movement wave. Transportation is the simplest entry of all enabling licences — it requires vehicles, GPS, training, and a manifest system, all of which are available in Ghana's existing logistics market.
            </p>
            {[
              {l:'NCC application start',v:'Now — Q2 2026'},
              {l:'First licensed transport operation',v:'Q4 2026 – Q1 2027'},
              {l:'First client trip',v:'Q4 2026 – Q2 2027'},
              {l:'GDP pharmaceutical scope',v:'2028 — after GDP certification'},
            ].map((p,i) => (
  ...
  <div className="pad-footer" style={{background:C.forest,padding:'16px 64px',borderTop:`3px solid ${C.lime}`}}>
    <div className="footer-inner" style={{maxWidth:'900px',margin:'0 auto',display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:'12px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'14px'}}>
        ...
        <div>
          <div style={{fontFamily:F.sans,fontSize:'10px',fontWeight:600,color:'rgba(250,248,243,0.45)',letterSpacing:'0.3px'}}>Licence 07 of 11 · Ghana Cannabis Intelligence</div>
