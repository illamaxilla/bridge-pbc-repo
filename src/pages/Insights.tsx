...
function SiteHeader({ activePage }) {
  ...
  const navItems = ["Home", "Services", "Sectors", "Insight", "Resources", "Contact"];
  return (
    <>
      <header
        style={{
          backgroundColor: scrolled ? "rgba(255,255,255,0.92)" : C.white,
          ...
          borderBottom: `1px solid ${scrolled ? "transparent" : C.line}`,
        }}
      >
            ...
            {navItems.map((item, i) => {
              ...
              return (
                <a
                  ...
                  style={{
                    color: isActive ? C.primary : hovNav === i ? C.primary : C.dark,
                    textDecoration: "none",
                    fontSize: "15px",
        ...
        {isMobile ? (
          <button
            ...
            style={{
              background: menuOpen ? C.dark : "transparent",
              border: `1.5px solid ${menuOpen ? C.dark : C.line}`,
              borderRadius: "10px",
              cursor: "pointer",
              padding: "8px",
              width: "40px",
          ...
          >
            <span
              style={{
                width: "18px",
                height: "1.5px",
                backgroundColor: menuOpen ? C.white : C.primary,
                borderRadius: "1px",
                transition: "all 0.3s",
          ...
          <nav style={{ display: "flex", flexDirection: "column", flex: 1 }}>
            {navItems.map((item) => (
              <a
                ...
                style={{
                  color: item === activePage ? C.accent : "rgba(255,255,255,0.85)",
                  textDecoration: "none",
                  fontSize: "24px",
