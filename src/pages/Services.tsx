...
const sectors = [
  ...
  },
  {
    ...
    vent: 18,
    metric: "$1.9B",
    mLabel: "Annual Post-Harvest Loss",
...
const connData = {
  ...
  "0-2": { mech: "Water & sanitation systems for health facilities", met: "85% facility coverage gap" },
  "0-3": { mech: "IoT sensors for water, power, and facility monitoring", met: "40% efficiency gain" },
  "0-4": { mech: "School facility construction and maintenance systems", met: "12,000 schools needing upgrades" },
  ...
  "1-2": { mech: "Health insurance & mobile payment for services", met: "68% uninsured population" },
  "1-3": { mech: "Mobile money platforms and fintech ecosystem", met: "$4-6B credit gap addressable" },
  "1-4": { mech: "Education financing and student loan platforms", met: "2.3M students underfinanced" },
  ...
  "1-7": { mech: "Mortgage products and housing microfinance", met: "2M+ unit deficit addressable" },
  "1-8": { mech: "Tourism SME lending and hospitality finance", met: "12,000 tourism SMEs" },
  "1-9": { mech: "Pay-as-you-go solar financing models", met: "1.2M off-grid households" },
  ...
  "2-5": { mech: "Nutrition programs linked to local food systems", met: "19% child malnutrition rate" },
  "2-6": { mech: "Health awareness through creative media campaigns", met: "15M media reach potential" },
  "2-7": { mech: "Healthy housing standards and indoor air quality", met: "35% respiratory illness link" },
  "2-8": { mech: "Medical tourism and wellness retreat development", met: "$120M medical tourism potential" },
  "2-9": { mech: "Reliable power for health facility equipment", met: "42% facilities with outages" },
  "2-10": { mech: "Local pharmaceutical manufacturing capacity", met: "70% drug import dependency" },
  "2-11": { mech: "Emergency medical transport and ambulance networks", met: "45-min avg response time" },
  "3-4": { mech: "Digital skills training and e-learning platforms", met: "57% youth underemployment" },
  "3-5": { mech: "Agritech for precision farming and market access", met: "$1.9B loss reduction potential" },
  ...
  "4-5": { mech: "Agricultural extension training programs", met: "3.2M farmers needing training" },
  "4-6": { mech: "Creative arts vocational training pipelines", met: "45,000 annual graduates needed" },
  "4-7": { mech: "Construction skills TVET certification", met: "120,000 skilled workers needed" },
  "4-8": { mech: "Hospitality and tourism management training", met: "8 training institutes needed" },
  "4-9": { mech: "Renewable energy technician certification", met: "5,000 technicians needed by 2030" },
  "4-10": { mech: "Manufacturing skills and apprenticeship programs", met: "65% skills gap in industry" },
  "4-11": { mech: "Commercial driving and logistics certification", met: "28,000 certified drivers needed" },
  "5-6": { mech: "Food culture media and culinary content", met: "12 regional food brands potential" },
  "5-7": { mech: "Agricultural land-use planning for housing", met: "40% peri-urban land conflicts" },
  ...
  "5-11": { mech: "Cold chain logistics from farm to market", met: "40% post-harvest loss reduction" },
  ...
  "6-10": { mech: "Local instrument and equipment manufacturing", met: "$45M equipment import bill" },
  ...
  "8-9": { mech: "Solar-powered eco-lodge and resort infrastructure", met: "85% off-grid tourism sites" },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseEnter={() => {
          if (!isMobile) setLogoHovered(true);
        }}
        onMouseLeave={() => {
          if (!isMobile) setLogoHovered(false);
        }}
      >
        <svg viewBox="0 0 3434.33 932.3" height={isMobile ? 28 : 36} style={{ display: "block" }}>
      ...
      {/* Navigation - desktop only, hidden on scroll */}
      {!isScrolled && !isMobile && (
        <nav
          style={{
            position: "absolute",
    ...
    <section style={{ backgroundColor: colors.background, padding: mb ? "60px 20px 80px" : "100px 80px" }}>
      <div style={{ maxWidth: MAX_W, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          >
            {mb
              ? "Each sector analysis contains 7,000+ words of rigorous research with value chain mapping and prioritized opportunities"
              : "Each sector analysis contains 7,000+ words of rigorous research including value chain mapping, stakeholder analysis, competitive landscape, and prioritized opportunities"}
          </p>
        </div>
        <div
          className="cs-scroll"
