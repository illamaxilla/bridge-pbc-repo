const Watchlist = () => (
  <div style={{ padding: "2.5rem 2rem", maxWidth: 860, margin: "0 auto" }}>
    ...
    <h1 style={{ color: "#1B4D3E", fontSize: "2rem", fontWeight: 800, margin: "0 0 0.5rem" }}>Watchlist</h1>
    <p style={{ color: "#4a5568", fontSize: "1rem", lineHeight: 1.7, maxWidth: 560 }}>
      Track and monitor your saved sectors, projects, and investment opportunities in one place.
    </p>
  </div>
);
