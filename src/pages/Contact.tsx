...
const Header = () => {
  ...
  return (
    <>
      <header
        style={{
          backgroundColor: scrolled ? "rgba(255,255,255,0.88)" : colors.white,
      ...
      >
            ...
            {navItems.map((item, i) => {
              ...
              return (
                <a
                  ...
                  style={{
                    color: active ? colors.primary : hovNav === i ? colors.primary : "#191919",
                    textDecoration: "none",
                    fontSize: "15px",
        ...
        {isMobile ? (
          <button
            ...
            style={{
              background: menuOpen ? "#191919" : "transparent",
              border: `1.5px solid ${menuOpen ? "#191919" : colors.line}`,
              borderRadius: "10px",
              cursor: "pointer",
              padding: "8px",
              width: "40px",
          ...
          >
            <span
              style={{
                width: "18px",
                height: "1.5px",
                backgroundColor: menuOpen ? colors.white : colors.primary,
                borderRadius: "1px",
                transition: "all 0.3s ease",
          ...
          <nav style={{ display: "flex", flexDirection: "column", flex: 1 }}>
            {navItems.map((item) => (
              <a
                ...
                style={{
                  color: item === "Contact" ? colors.accent : "rgba(255,255,255,0.85)",
                  textDecoration: "none",
                  fontSize: "24px",
                  fontWeight: item === "Contact" ? "700" : "400",
                  fontFamily: "Inter, sans-serif",
                  padding: "20px 0",
