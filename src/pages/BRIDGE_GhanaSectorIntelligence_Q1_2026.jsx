...
const Fonts = () => (
  <style>{`
    @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;0,900;1,400;1,600;1,700&family=Source+Serif+4:ital,wght@0,300;0,400;0,600;1,300;1,400&family=DM+Sans:wght@300;400;500;600;700;800&family=DM+Mono:wght@300;400;500&display=swap');
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 768px) {
      ...
      .cover-headline { font-size: 48px !important; }
    }
  `}</style>
);
...
const EditorsLetter = () => (
  <div style={{ background: C.paper, padding: '72px 56px' }} className="paper-texture">
...
const MacroIndicators = () => (
  <div style={{ background: C.paperDark, padding: '72px 56px', borderTop: `1px solid ${C.border}` }}>
    <div style={{ maxWidth: '860px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '40px' }}>
        <div style={{
          ...
          {['Economic Indicator', 'Reading', 'Change', 'BRIDGE Signal'].map(h => (
            <div key={h} style={{ fontFamily: F.sans, fontSize: '9px', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', color: C.muted }}>{h}</div>
          ))}
        </div>
...
const SectorMap = () => {
  ...
  return (
    <div style={{ background: C.paper, padding: '72px 56px', borderTop: `1px solid ${C.border}` }}>
      <div style={{ maxWidth: '860px', margin: '0 auto' }}>
...
const SectorSpotlight = () => (
  <div style={{ background: C.forest, padding: '72px 56px' }}>
    <div style={{ maxWidth: '860px', margin: '0 auto' }}>
...
const MembersGate = () => (
  <div style={{
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '56px', alignItems: 'start' }} className="two-col">
        <div>
        ...
        <div>
          <div style={{
            ...
            <div style={{ fontFamily: F.mono, fontSize: '32px', color: C.lime, marginBottom: '12px', lineHeight: 1 }}>★</div>
...
const Colophon = () => (
  <div style={{
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
...
const TopBar = ({ coverLogoRef }) => {
  ...
  return (
    <div className="no-print" style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        {/* Logo fades in only after cover masthead scrolls out of view */}
        <div style={{
          overflow: 'hidden',
          maxWidth: pastLogo ? '200px' : '0px',
          opacity: pastLogo ? 1 : 0,
          transition: 'max-width 0.35s ease, opacity 0.3s ease',
          display: 'flex', alignItems: 'center',
        }}>
          <BridgeLogo height={20} variant="dark" />
          <div style={{ width: '1px', height: '16px', background: C.border, margin: '0 10px', flexShrink: 0 }} />
        </div>
        <span style={{ fontFamily: F.sans, fontSize: '11px', color: C.muted }}>
          Ghana Intelligence · Q1 2026 · Free Public Edition
        </span>
      </div>
      <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
        <a href="#" style={{
          fontFamily: F.sans, fontSize: '11px', fontWeight: 700,
          color: C.forest, textDecoration: 'none', letterSpacing: '0.3px',
        }}>Members Access →</a>
        <button
